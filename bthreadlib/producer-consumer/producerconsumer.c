//
// Created by massi on 24.05.2020.
//
...
int main(int argc, char *argv[]) {
    ...
    bthread_create(&producer1, NULL, producer, NULL);
    bthread_create(&consumer1, NULL, consumer, NULL);
    bthread_create(&consumer2, NULL, consumer, NULL);
